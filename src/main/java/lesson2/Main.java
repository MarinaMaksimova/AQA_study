...
public class Main {
    ...
    public static boolean compareNumbersBoolean(int a, int b) {
        if ((a + b) >=10 && (a + b) <=20){
            return true;
        } else {
            return false;
    ...
    public static void comparePositiveNegative(int a) {
        if (a >= 0){
    ...
    public static boolean comparePositiveNegativeBoolean(int a) {
        if (a < 0){
            return true;
        } else {
            return false;
     ...
     /* 8. Напишите метод, которому в качестве аргументов передается строка и
            ...
            количество раз. */
     public static void printStringNTimes(String str, int a) {
         a = Math.abs(a);
    ...
    public static boolean defineLeapYearBoolean(int a) {
        if (a % 4 == 0) {
            if (a % 100 == 0) {
                if (a % 400 == 0){
                    return true;
    ...
    /* 14. Написать метод, принимающий на вход два аргумента: len и initialValue, и
            ...
            initialValue. */
    public static void createCustomArray(int len, int initialValue) {
        int [] arr = new int[len];
        for (int i = 0; i < arr.length; i++) {
            arr[i]=initialValue;
            System.out.print (arr[i] + " ");
    ...
    public static void main(String[] args) {
        ...
        System.out.println (compareNumbersBoolean(15, 5) +"\n");

        System.out.println("Задание 6:");
        comparePositiveNegative(3);

        System.out.println("Задание 7:");
        System.out.println (comparePositiveNegativeBoolean(0) +"\n");

        System.out.println("Задание 8:");
        printStringNTimes("строка", -3);
        System.out.println ();

        System.out.println("Задание 9:");
        System.out.println (defineLeapYearBoolean(2023) +"\n");
